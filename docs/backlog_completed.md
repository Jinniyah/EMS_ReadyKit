...
Locked sequence per Jennifer: F-5G3a (Bobby's compliance CSV export) is next, followed by VALID-1 (live UAT validation) and INFRA-UAT1 (UAT/PROD environment split) — not started this session.
