...
def _item(
    ...
    *,
    ...
    item = Item(
        ...
        active=True,
        station_supply=False,  # AED/LUCAS are not supply-room items
...
class TestAEDChecks:
    ...
    def test_aed_functional_pass_check_submits(self, client, db, auth_responder):
        ...
        _par(
            ...
            comp=comp,
            priority=True,
            question="AED powered on and ready?",
        )
    ...
    def test_submitted_check_is_immutable(
        ...
        assert (
            li["functional_pass"] is True
        ), "AED PASS reading was modified — CRITICAL legal issue"

    def test_aed_fail_preserves_original_record(
        self, client, db, auth_responder, auth_supervisor
    ):
        """
        ...
        assert (
            li.get("notes") == "AED battery depleted"
...
class TestLUCASChecks:
    ...
    def test_lucas_functional_pass_submits(self, client, db, auth_responder):
        ...
        _par(
            ...
            comp=comp,
            priority=True,
            question="LUCAS powered on and ready?",
        )
    ...
    def test_lucas_functional_fail_records_and_does_not_block(
    ...
    def test_lucas_fail_original_record_preserved(
        self, client, db, auth_responder, auth_supervisor
    ):
...
class TestPriorityFlags:
    ...
    def test_priority_flag_readable_from_par_level_api(self, client, db, auth_admin):
        ...
        _par(
            ...
            comp=comp,
            priority=True,
            question="AED powered on and ready for use?",
        )
