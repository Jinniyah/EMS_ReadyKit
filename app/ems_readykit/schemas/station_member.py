...
class StationMemberCreate(BaseModel):
    ...
    preferred_name: Optional[str]  = Field(None, max_length=100, description="Display name shown in the UI")
...
class StationMemberUpdate(BaseModel):
    ...
    role:           Optional[str] = Field(None, description="Administrator | Supervisor | Responder")
