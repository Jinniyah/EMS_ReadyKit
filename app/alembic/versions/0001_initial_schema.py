...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "location_type", sa.String(30), nullable=False
        ),  # VEHICLE / STATION_SUPPLY_ROOM
        sa.Column(
            "station_id",
            sa.Integer,
            sa.ForeignKey("stations.station_id"),
    ...
    op.create_table(
        ...
        ),  # Medication / Consumable / Equipment
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "item_id", sa.Integer, sa.ForeignKey("items.item_id"), nullable=False
        ),
        sa.Column(
            "location_id",
            sa.Integer,
    ...
    op.create_table(
        ...
        sa.Column("timestamp", sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            "discrepancy_flag", sa.Boolean, nullable=False, server_default=sa.false()
        ),
    ...
    op.create_index(
        "ix_daily_checks_check_date", "daily_inventory_checks", ["check_date"]
    )
